...
const ProfileScreen = ({ navigation, route }: ProfileScreenProps) => {
  const isMyProfile = route?.params?.isMyProfile ?? false;
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.coverSection}>
          ...
          <View style={styles.statsContainer}>
             {showHiverBadge && (
              <TouchableOpacity onPress={()=>navigation.navigate('RelationFinder')} style={styles.hiverBadge}>
                <Text allowFontScaling={false} style={styles.hiverText}>HIVER</Text>
                <View style={{
              height:5,width:5,borderRadius:2.5,backgroundColor:'#fff',
                }}/>
              </TouchableOpacity>
            )}
